            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('kendaraan.store') }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('konsumsi_bahan_bakar') is-invalid @enderror" 
                                           ...
                                           value="{{ old('konsumsi_bahan_bakar') }}" min="0" step="0.1">
                        ...
                        <!-- Tambahkan checkbox untuk tersedia -->
                        <div class="form-group">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="tersedia" 
                                       name="tersedia" value="1" checked>
                                <label class="form-check-label" for="tersedia">
                                    Kendaraan Tersedia
                                </label>
                                <small class="form-text text-muted d-block">
                                    Centang jika kendaraan tersedia untuk digunakan
                                </small>
                            </div>
                        </div>
