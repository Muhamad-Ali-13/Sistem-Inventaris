                    ...
                    <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    ...
                                                    <select class="form-control" id="type" name="type" required>
                                                        ...
                                                        <option value="item-requests">Permintaan Barang</option>
                                                        <option value="vehicle-usage">Penggunaan Kendaraan</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-4">
                        ...
                        <div class="row mt-4">
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Ringkasan Permintaan Barang</h3>
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Ringkasan Penggunaan Kendaraan</h3>
                                    </div>
                                    <div class="card-body">
                                        <div class="row text-center">
                                            <div class="col-3">
                        ...
                        <div class="row mt-4">
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Barang Populer (Paling Banyak Diminta)</h3>
                                    </div>
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    @else
                                                        <tr>
                                                            <td colspan="2" class="text-center">Format data salah</td>
                                                        </tr>
                                                    @endif
                                                </tbody>
                                            </table>
